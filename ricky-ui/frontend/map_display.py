...
Updated: Visual Debugging & Robust Rendering
"""
...
class LightweightMapWidget(QWidget):
    ...
    def __init__(self):
        ...
        # Debug state
        self.last_gps_update = "Waiting for GPS..."
    ...
    def render_map(self):
        ...
        painter.drawText(10, 30, f"DEBUG: {self.last_gps_update}")
    ...
    def update_gps_location(self, lat, lon):
        ...
        self.last_gps_update = f"GPS: {lat:.5f}, {lon:.5f}"
