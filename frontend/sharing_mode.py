...
class PassengerCard(QFrame):
    ...
    def setup_ui(self):
        ...
        # 5. NOW apply the style (Fix: Called AFTER variables are created)
    ...
    def set_offboard_style(self):
        ...
        """)
        # We can safely access these now because they were created in setup_ui
