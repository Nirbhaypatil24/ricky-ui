...
class AdsDisplayWidget(QWidget):
    ...
    def setup_ui(self):
        # Slightly shorter to fit header and spacing
    ...
    def create_ad(self, title, subtitle, color):
        ...
        lbl_t = QLabel(title)
        lbl_t.setStyleSheet("color: white; font-size: 28px; font-weight: bold; background: transparent;")
        lbl_t.setAlignment(Qt.AlignCenter)
        
        lbl_s = QLabel(subtitle)
        lbl_s.setStyleSheet("color: white; font-size: 18px; background: transparent;")
