...
class RickyUI(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.for_hire_widget = self.create_placeholder_widget("OR HIRE", "Ready for passengers", THEME_SUCCESS)
        self.waiting_widget = self.create_placeholder_widget("WAITING", "Driver on break", "#8E8E93")
